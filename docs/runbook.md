...
| Issue | Fix |
|---|---|
| **Supabase project paused** — DB connections start timing out or refusing. | Supabase dashboard → the project → **Unpause**. Takes ~2 minutes to come back online; retry the failing operation after that. |
