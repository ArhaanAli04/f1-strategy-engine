...
// Adapted from web's RegisterPage.tsx — no react-router (Link/useNavigate),
// navigation back to Login is a prop callback instead, same pattern as
// every other desktop page switch (see App.tsx).
export function RegisterPage({ onNavigateToLogin }: RegisterPageProps) {
  ...
  async function onSubmit(values: RegisterFormValues) {
    ...
    try {
      ...
      // (see backend/apis/v1/auth.py). User logs in next.
